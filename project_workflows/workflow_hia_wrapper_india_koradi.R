...
for (i_Sc in seq(1,12)) {
# Parameters ####################################################################################
# ============================= Project specific ================================================
# Select macro scenarios
if (i_Sc==1) {scenario_prefix <- "ScA_all" ; scenario_description='KORADI CFPP, all units, SO2 compliance, 85% PLF'}
if (i_Sc==2) {scenario_prefix <- "ScA_67"  ; scenario_description='KORADI CFPP, units 6-7, SO2 compliance, 85% PLF'}
if (i_Sc==3) {scenario_prefix <- "ScA_890" ; scenario_description='KORADI CFPP, units 8-9-10, SO2 compliance, 85% PLF'}

if (i_Sc==4) {scenario_prefix <- "ScB_all" ; scenario_description='KORADI CFPP, all units, SO2 compliance, actual PLF'}
if (i_Sc==5) {scenario_prefix <- "ScB_67"  ; scenario_description='KORADI CFPP, units 6-7, SO2 compliance, actual PLF'}
if (i_Sc==6) {scenario_prefix <- "ScB_890" ; scenario_description='KORADI CFPP, units 8-9-10, SO2 compliance, actual PLF'}

if (i_Sc==7 ){scenario_prefix <- "ScC_all" ; scenario_description='KORADI CFPP, all units, actual SO2, 85% PLF'}
if (i_Sc==8 ){scenario_prefix <- "ScC_67"  ; scenario_description='KORADI CFPP, units 6-7, actual SO2, 85% PLF'}
if (i_Sc==9 ){scenario_prefix <- "ScC_890" ; scenario_description='KORADI CFPP, units 8-9-10, actual SO2, 85% PLF'}

if (i_Sc==10){scenario_prefix <- "ScD_all" ; scenario_description='KORADI CFPP, all units, actual SO2, actual PLF'}
if (i_Sc==11){scenario_prefix <- "ScD_67"  ; scenario_description='KORADI CFPP, units 6-7, actual SO2, actual PLF'}
if (i_Sc==12){scenario_prefix <- "ScD_890" ; scenario_description='KORADI CFPP, units 8-9-10, actual SO2, actual PLF'}
...
project_dir="I:/india_koradi"          # calpuff_external_data-3 persistent disk (project data)
